<template>
    <view>
            ...
            <div class="squall_buttom_Map" :style="ButtomMap">      
              <el-row style="margin-bottom:10px;margin-top:10px;height:50px">
                  <el-col :span="8" :offset="3">
                    <el-button type="primary" style="width:100%" @click="SubSubPageFlag=true">新增</el-button>
                  </el-col>
                  <!--<el-col :span="6" :offset="2">
                    <el-button type="primary" style="width:100%" @click="InfoDialogVisible=true">基本信息</el-button>
                  </el-col>
                  <el-col :span="6" :offset="1">
                    <el-button type="primary" style="width:100%" @click="DealDialogVisible=true">处置信息</el-button>
                  </el-col>-->
      ...
      <transition name="el-fade-in">
        <div class="squall_sub_page" v-if="SubSubPageFlag">
          <!--这里是点击之后的结果，全屏显示出来-->
          <el-row :style="TopLabel">
              <el-col :span="22" :offset="1">
                <h2>{{Weijiandidian}}</h2>
          ...
          <el-row>
            <el-col :span="24">
              ...
              >
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="利用时间">
                      <el-date-picker
                        v-model="ReuseForm.lysj"
                        type="date"
                      >
                      </el-date-picker>
                    </el-form-item>
                  ...
                  <el-col :span="24">
                    <el-form-item label="本月利用">
                      <el-input v-model="ReuseForm.bylymj">
                  ...
                  <el-col :span="24">
                    <el-form-item label="违建占地">
                      <el-input v-model="ReuseForm.wjzdmj">
                        <template slot="append">
                          ㎡
                        </template>
                      </el-input>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="情况说明">
                      <el-input v-model="ReuseForm.qksm"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="24">
                  <el-form-item class="PicUpload" label="利用后照片">
                    <el-upload 
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="利用类型">
                      <el-select v-model="ReuseForm.lylx">
                        <el-option
                          v-for="Item in lylx"
                          :key = "Item.value"
                          :label = "Item.label"
                  ...
                  <el-form-item label="报送人">
                    <el-input v-model="ReuseForm.bsr"></el-input>
                  </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  ...
                  <el-form-item label="报送单位">
                    <el-input v-model="ReuseForm.bsdw"></el-input>
                  </el-form-item>
                  </el-col>
                </el-row>
              </el-form>    
          ...
          <el-row>
            <div class="squall_buttom_Map" :style="ButtomMap">      
              <el-row style="margin-bottom:10px;margin-top:10px;height:50px">
                  <el-col :span="8" :offset="3">
                    <el-button type="primary" style="width:100%" @click="SubmitInfoItem()">确定</el-button>
                  </el-col>
                  <!--<el-col :span="6" :offset="2">
                    <el-button type="primary" style="width:100%" @click="InfoDialogVisible=true" >基本信息</el-button>
                  </el-col>
                  ...
                  <el-col :span="8" :offset="2">
                    <el-button type="primary" style="width:100%" @click="SubSubPageBack()">取消</el-button>
                  </el-col>
              </el-row>
            </div>
          </el-row>
            ...
            <el-col :span="24">
              ...
              >
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="位置信息">
                      <el-input v-model="DealForm.LatLng" disabled>
                      </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="24">
...
export default {
  ...
  data () {
    return {
      ...
      lylx:[
        {label:"复垦",value:"复垦"},
        {label:"复绿（包括临时绿化）",value:"复绿（包括临时绿化）"},
        {label:"按规划进行建设",value:"按规划进行建设"},
        {label:"临时公共设施",value:"临时公共设施"},
      ],
    }
  },
  components: {
  ...
  mounted:function(){
    ...
    this.MidForm  = "height:" + (window.innerHeight-squall_top) + "px";
    this.ButtomMap  = "top:" + (window.innerHeight-squall_top)  + "px;height:" + (60) + "px;";
    this.DialogMap = "height:" + (window.innerHeight-120) + "px";
    this.SubPageTableHeight = window.innerHeight-240;

    //对数据库进行检索
    this.basic.squall_basic_http.GetDealList(this,{});
  },
  methods:{
    HandleCell:function (Index,Datalist) {
      ...
      //对数据库进行检索
      this.basic.squall_basic_http.GetReuseInfo(this,{"id":Datalist[Index].id});
      this.SelectID = Datalist[Index].id;
      this.Weijiandidian = Datalist[Index].wjdd;

      //初始化基本信息
      this.ReuseForm.bsdw = this.global.sbdw;
      this.ReuseForm.bsr = this.global.lxr;
      this.ReuseForm.lxdh = this.global.lxfs;
    ...
    OpenDialog(){
      ...
      setTimeout(function(){
        ...
        this.Map.on("click",function(event){
          ...
          that.ReuseForm.LatLng = "经度:" + that.basic.BasicTool.PointAdjust(event.latlng.lng,6)  + ",纬度:" + that.basic.BasicTool.PointAdjust(event.latlng.lat,6);
        })
    ...
    SearchKeywords(){
      this.basic.squall_basic_http.GetDealList(this,{keywords:this.SearchText});
    },
    SubmitInfoItem(){
      var squall_TempInfo = {}
      for(var InfoIndex in this.ReuseForm)
      {
        squall_TempInfo[InfoIndex] = this.ReuseForm[InfoIndex];
        if(InfoIndex=="lysj")
        {
          var squall_TempDate = new Date(this.ReuseForm[InfoIndex]);
          squall_TempInfo[InfoIndex] = this.basic.BasicTool.ReMakeDateString(squall_TempDate.getFullYear() + "-" + (squall_TempDate.getMonth()+1) + "-" + squall_TempDate.getDate());
        }
      }

      squall_TempInfo.lyxxzt = "待审核";
      squall_TempInfo.guid = this.basic.BasicTool.CreateGuid();
      squall_TempInfo.id = this.SelectID;

      var squall_PicPath = this.file[0].response.split('\\');
      squall_TempInfo.file = squall_PicPath[squall_PicPath.length-1];

      this.basic.squall_basic_http.AddReuseInfo(this,{
        data:squall_TempInfo
      });
    },
