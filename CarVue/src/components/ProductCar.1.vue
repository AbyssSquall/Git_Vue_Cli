    ...
    <div>
        ...
        <form class="layui-form" action="">
            <div class="layui-form-item layui-col-xs11 layui-col-sm11 layui-col-md11">
                ...
                <div class="layui-input-block">
                    <select name="range" lay-verify="">
                        <option value="incity">大市区内</option>
            ...
            <div class="layui-form-item layui-col-xs11 layui-col-sm11 layui-col-md11">
                ...
                <div class="layui-input-block">
                    <input type="text" name="driver" required  lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item layui-col-xs11 layui-col-sm11 layui-col-md11">
                <label class="layui-form-label">车牌号</label>
                <div class="layui-input-block">
                    <select name="carid" lay-verify="">
                        <option value="">请选择车辆</option>
                        <option value="100400">浙B96C08</option>
                        <option value="100427">浙BH2B07</option>
                    </select> 
                </div>
            </div>
            <div class="layui-form-item layui-col-xs11 layui-col-sm11 layui-col-md11">
                ...
                <div class="layui-input-block">
                    <input type="text" name="aim" required  lay-verify="required" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item layui-col-xs11 layui-col-sm11 layui-col-md11">
            ...
            <div class="layui-form-item layui-col-xs11 layui-col-sm11 layui-col-md11">
                ...
                <div class="layui-input-block">
                    <textarea name="reason" style="resize:none;" class="layui-textarea"></textarea>
                </div>
            </div>
