var BasicTools = require('./BasicTools');
var Config = require("../Config/Config");
var request = require("sync-request");
var PYTranslator = require("js-pinyin");
var qs = require("qs");

//拼音设定
PYTranslator.setOptions({checkPolyphone: false, charCase: 0});
...
function CreateProvincePostBody(_BaseInfoJSON,_Item,_Detail,_ServerCode){
    ...
    if(_ServerCode.indexOf("确认")!=-1){
        ...
        //转化为拼音
        if(AcceptJSON[Config.TableAlias[_ServerCode].table]["BMMX0002"])
            AcceptJSON[Config.TableAlias[_ServerCode].table]["BMMX0018"] = PYTranslator.getFullChars(AcceptJSON[Config.TableAlias[_ServerCode].table]["BMMX0002"])
