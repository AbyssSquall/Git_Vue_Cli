    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" @selection-change="handleSelectionChange" v-loading="loading">
                ...
                <el-table-column prop="BO_NAME" label="boss" width="120">
                </el-table-column>
                <el-table-column prop="PL_NAME" label="玩家" width="120">
                </el-table-column>
                <el-table-column prop="BL_DEMAGE" label="伤害">
                </el-table-column>
                <el-table-column prop="BL_TIME" label="时间" sortable width="250">
                </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                this.$axios({
                    method: 'get',
                    url: that.msdburl + '/queryexcute?sql=' + encodeURIComponent("select * from player,boss,blade where boss.BO_GUID=blade.BO_GUID and player.PL_GUID=blade.PL_GUID"),
                    headers:{
