...
var SpiderAPI = require("../SquallAPI/SpiderFunc");
...
//Get Require
router.get('/i-test',async function(req,res){
    //获取wiki页面并提取舰船信息
    console.log(JSON.parse(SpiderAPI.GetShipData()));

    res.end("This is Interface-Test! ver 0.0.000001");
})
